...
public class DListFeedbackAdapter extends RecyclerView.Adapter<DListFeedbackAdapter.ViewHolder> {
    private List<Feedback> listFeedback;
    private FeedbackFireBaseDAO feedbackFireBaseDAO;
    private Context context;
    public DListFeedbackAdapter(Context context, FeedbackFireBaseDAO feedbackFireBaseDAO, List<Feedback> listFeedback){
    ...
    @NonNull
    @Override
    public DListFeedbackAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DListFeedbackAdapter.ViewHolder holder, int position) {
